...
import com.wzq.jz_app.presenter.BillPresenter;
...
public class AddActivity extends BaseMVPActivity<BillContract.Presenter>
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        if (bundle != null) {    //edit
            isEdit = true;
            //设置账单日期
            days = DateUtils.long2Str(bundle.getLong("date"), DateUtils.FORMAT_YMD);
    ...
    protected void initViewPager() {
        ...
        viewpagerItem.setAdapter(new MonthChartAdapter(viewList));
